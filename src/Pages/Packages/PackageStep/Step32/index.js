...
import {
    ...
    insertUpdatePackageStep32,
    getPackageStep32ById,
    getPackageStep32Document,
...
export default function PackageStep32Page() {
    ...
    const handleDownload = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/docs/template_ba_pembayaran.docx`;

        // Set the download attribute with the filename
        link.download = 'template_ba_pembayaran.docx';

        // Programmatically click the link to trigger the download
        link.click();
    };

    const handleDownloadBAHasilPemeriksaan = () => {
        // Create a link element
        const link = document.createElement('a');

        // Set the href attribute to the path of the file in the public directory
        link.href = `${process.env.PUBLIC_URL}/docs/berita_acara_hasil_pemeriksaan.docx`;

        // Set the download attribute with the filename
        link.download = 'berita_acara_hasil_pemeriksaan.docx';

        // Programmatically click the link to trigger the download
        link.click();
    };

    const handleDownloadBobotPekerjaan = () => {
        // Create a link element
        const link = document.createElement('a');

        // Set the href attribute to the path of the file in the public directory
        link.href = `${process.env.PUBLIC_URL}/docs/berita_acara_bobot_pekerjaan.docx`;

        // Set the download attribute with the filename
        link.download = 'berita_acara_bobot_pekerjaan.docx';

        // Programmatically click the link to trigger the download
        link.click();
    };

    const handleDownloadTemplateBast = () => {
        // Create a link element
        const link = document.createElement('a');

        // Set the href attribute to the path of the file in the public directory
        link.href = `${process.env.PUBLIC_URL}/docs/template_bast.docx`;

        // Set the download attribute with the filename
        link.download = 'template_bast.docx';

        // Programmatically click the link to trigger the download
        link.click();
    };

    const handleDownloadTemplateBAKemajuanPekerjaan = () => {
        // Create a link element
        const link = document.createElement('a');

        // Set the href attribute to the path of the file in the public directory
        link.href = `${process.env.PUBLIC_URL}/docs/berita_acara_kemajuan_pekerjaan.docx`;

        // Set the download attribute with the filename
        link.download = 'berita_acara_kemajuan_pekerjaan.docx';
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep32(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep32ById(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep32Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep32ById(cookies.token, stepDocumentId);
                                                ...
                                                <div style={{
                                                    ...
                                                    <div style={{
                                                        ...
                                                        <div style={{
                                                            display: "flex",
                                                            flex: 4
                                                        }}>{detailPackage.package_name}</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div style={{
                                                    ...
                                                    <div style={{
                                                        ...
                                                        <div style={{
                                                            display: "flex",
                                                            flex: 4
                                                        }}>{detailPackage.selection_methode}</div>
                                                    </div>
                                                </div>
                                                <div style={{
                                                    display: "flex",
                                                    ...
                                                    <div style={{
                                                        ...
                                                        <div style={{
                                                            display: "flex",
                                                            flex: 4
                                                        }}>{formatCurrency(detailPackage.pagu)}</div>
                                                    </div>
                                                </div>
                                                <div style={{
                                                    display: "flex",
                                                    ...
                                                    <div style={{
                                                        ...
                                                        <div style={{
                                                            display: "flex",
                                                            flex: 4
                                                        }}>{formatCurrency(detailPackage.hps)}</div>
                                                    </div>
                                                </div>
                                                <div style={{
                                                    display: "flex",
                                                    ...
                                                    <div style={{
                                                        ...
                                                        <div style={{
                                                            display: "flex",
                                                            flex: 4
                                                        }}>{formatCurrency(detailPackage.kontrak)}</div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                <h5>Unduh dan Unggah Dokumen Pembayaran</h5>
                                            </div>
                                            <div style={{
                                                paddingBottom: 10
                                            }}></div>
                                            ...
                                            <div style={{
                                                    ...
                                                    <>
                                                        <div style={{
                                                            ...
                                                            <div style={{
                                                                ...
                                                                <div>Unduh Template Dokumen Pembayaran</div>
                                                                <Button style={{
                                                                    width: 150,
                                                                    height: 40
                                                                }} onClick={() => {
                                                                    handleDownload()
                                                                }}><p style={{ fontSize: 10, alignItems: "center" }}><FileWord size={20} /> Unduh Format docx</p> </Button>
                                                                <div>Unduh Template Berita Acara Hasil Pemeriksaan</div>
                                                                <Button style={{
                                                                    width: 150,
                                                                    height: 40
                                                                }} onClick={() => {
                                                                    handleDownloadBAHasilPemeriksaan()
                                                                }}><p style={{ fontSize: 10, alignItems: "center" }}><FileWord size={20} /> Unduh Format docx</p> </Button>
                                                                <div>Unduh Template Berita Acara Kemajuan Pekerjaan</div>
                                                                <Button style={{
                                                                    width: 150,
                                                                    height: 40
                                                                }} onClick={() => {
                                                                    handleDownloadTemplateBAKemajuanPekerjaan()
                                                                }}><p style={{ fontSize: 10, alignItems: "center" }}><FileWord size={20} /> Unduh Format docx</p> </Button>
                                                            </div>
                                                            <div style={{
                                                                display: "flex",
                                                                ...
                                                                <div>Unduh Template BAST</div>
                                                                <Button style={{
                                                                    width: 150,
                                                                    height: 40
                                                                }} onClick={() => {
                                                                    handleDownloadTemplateBast()
                                                                }}><p style={{ fontSize: 10, alignItems: "center" }}><FileWord size={20} /> Unduh Format docx</p> </Button>
                                                                <div>Unduh Template Bobot Pekerjaan</div>
                                                                <Button style={{
                                                                    width: 150,
                                                                    height: 40
                                                                }} onClick={() => {
                                                                    handleDownloadBobotPekerjaan()
                                                                }}><p style={{ fontSize: 10, alignItems: "center" }}><FileWord size={20} /> Unduh Format docx</p> </Button>
                                                ...
                                                <div style={{
                                                    ...
                                                    <div hidden={cookies.userRole !== 2} style={{
                                                        ...
                                                        <Button hidden={listDocument.length > 4} variant="primary" style={{
                                                            width: 130
                                                        }} onClick={() => {
