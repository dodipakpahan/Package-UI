...
import {
    ...
    insertUpdatePackageStep31,
    getPackageStep31ById,
    getPackageStep31Document,
...
export default function PackageStep31Page() {
    ...
    const handleDownload = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/docs/berita_acara_serah_terima_pertama.docx`;

        // Set the download attribute with the filename
        link.download = 'berita_acara_serah_terima_pertama.docx';
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep31(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep31ById(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep31Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep31ById(cookies.token, stepDocumentId);
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                <h5>Unduh dan Unggah Dokumen Berita Acara</h5>
                                            </div>
                                            <div style={{
                                                paddingBottom: 10
                                            }}></div>
                                            ...
                                            <div style={{
                                            ...
                                            }}>
                                                {
                                                    cookies.userRole === 2 &&
                                                    <>
                                                        <div>Unduh Template Dokumen Berita Acara</div>
                                                        <Button style={{
                                                            width: 150,
                                                            height: 40
                                                        }} onClick={() => {
                        ...
                        <Modal show={showDocumentUploadModal}
                            ...
                            <div className="details m-2" >
                                <div className="detailscontent">
                                    <h3>Dokumen Berita Acara Serah Terima Pertama </h3>
                                </div>
