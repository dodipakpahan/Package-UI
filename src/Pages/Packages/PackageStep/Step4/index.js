...
import {
    ...
    insertUpdatePackageStep4, updateStep4DocumentStatus,
    getPackageStep4ById,
    getPackageStep4Document,
    deleteDocumentStep
...
export default function PackageStep4Page() {
    ...
    const [command, setCommand] = useState({
        id: 0,
        command_penyedia: "",
        package_step_id: location.state.stepId
    })
    ...
    const handleDownload = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/docs/kontrak_mdp.rar`;

        // Set the download attribute with the filename
        link.download = 'kontrak_mdp.rar';
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let res = await insertUpdatePackageStep4(cookies.token, newDocument, packageId, window.location.pathname, detailPackage.account_type);
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep4ById(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep4Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep4ById(cookies.token, stepDocumentId);
    ...
    const loadDocumentApproved = async () => {
        try {
            let response = await getPackageStep4ById(cookies.token, approveId);
    ...
    const ApproveDocument = async (documentId) => {
        try {
            ...
            let response = await updateStep4DocumentStatus(cookies.token, stepPayload, detailPackage.account_type);
    ...
    const removeDocument = async () => {
        try {
            let response = await deleteDocumentStep(cookies.token, removeId, 4);
            if (response === 0) {
