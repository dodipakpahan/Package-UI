...
export default function PackageStep4Page() {
    ...
    const handleDownload = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/docs/draft_kontrak_gabungan_dan_lumsum.docx`;

        // Set the download attribute with the filename
        link.download = 'draft_kontrak_gabungan_dan_lumsum.docx';
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let res = await insertUpdatePackageStep4(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const ApproveDocument = async (documentId) => {
        try {
            ...
            let response = await updateStep4DocumentStatus(cookies.token, stepPayload);
