...
import {
    ...
    insertUpdatePackageStep27,
    getPackageStep27ById,
    getPackageStep27Document,
...
export default function PackageStep27Page() {
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep27(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep27ById(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep27Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep27ById(cookies.token, stepDocumentId);
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                <h5>Unduh dan Unggah Dokumen Pemberian Kesempatan</h5>
                                            </div>
                                            <div style={{
                                                paddingBottom: 10
                                            }}></div>
                                            ...
                                            <div style={{
                                            ...
                                            }}>
                                                {
                                                    cookies.userRole === 2 &&
                                                    <>
                                                        <div>Unduh Template Dokumen Pemberian Kesempatan</div>
                                                        <Button style={{
                                                            width: 150,
                                                            height: 40
                                                        }} onClick={() => {
                        ...
                        <Modal show={showDocumentUploadModal}
                            ...
                            <div className="details m-2" >
                                <div className="detailscontent">
                                    <h3>Dokumen Pemberian Kesempatan </h3>
                                </div>
