...
import {
    ...
    insertUpdatePackageStep6,
    getPackageStep6ById,
    getPackageStep6Document,
    updateStep6DocumentStatus,
    deleteDocumentStep
...
export default function PackageStep6Page() {
    ...
    const handleDownload = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/docs/undangan_rapat_spmk.docx`;

        // Set the download attribute with the filename
        link.download = 'undangan_rapat_spmk.docx';

        // Programmatically click the link to trigger the download
        link.click();
    };

    const handleDownloadSPMK = () => {
        // Create a link element
        const link = document.createElement('a');

        // Set the href attribute to the path of the file in the public directory
        link.href = `${process.env.PUBLIC_URL}/docs/spmk.docx`;

        // Set the download attribute with the filename
        link.download = 'spmk.docx';
    ...
    const handleDownloadBA = () => {
        ...
        // Set the href attribute to the path of the file in the public directory
        link.href = `${process.env.PUBLIC_URL}/docs/berita_acara_penyerahan_spmk.docx`;

        // Set the download attribute with the filename
        link.download = 'berita_acara_penyerahan_spmk.docx';
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep6(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep6ById(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep6Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep6ById(cookies.token, stepDocumentId);
    ...
    const loadDocumentApproved = async () => {
        try {
            let response = await getPackageStep6ById(cookies.token, approveId);
    ...
    const ApproveDocument = async (documentId) => {
        try {
            ...
            let response = await updateStep6DocumentStatus(cookies.token, stepPayload);
    ...
    const removeDocument = async()=>{
        try {
            let response = await deleteDocumentStep(cookies.token, removeId,6);
            if(response === 0){
                                                    ...
                                                    <Table striped bordered hover>
                                                        <thead >
                                                            <tr>
                                                                ...
                                                                <th style={{ width: 130, textAlign: "center", verticalAlign: "middle" }} hidden={cookies.userRole !== 1}>Setuju</th>
