...
import {
    ...
    insertUpdatePackageStep26,
    getPackageStep26ById,
    getPackageStep26Document,
...
export default function PackageStep26Page() {
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep26(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep26ById(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep26Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep26ById(cookies.token, stepDocumentId);
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                <h5>Unduh dan Unggah Dokumen Pemutusan Kontrak</h5>
                                            </div>
                                            <div style={{
                                                paddingBottom: 10
                                            }}></div>
                                            ...
                                            <div style={{
                                            ...
                                            }}>
                                                {
                                                    cookies.userRole === 2 &&
                                                    <>
                                                        <div>Unduh Template Dokumen Pemutusan Kontrak</div>
                                                        <Button style={{
                                                            width: 150,
                                                            height: 40
                                                        }} onClick={() => {
                        ...
                        <Modal show={showDocumentUploadModal}
                            ...
                            <div className="details m-2" >
                                <div className="detailscontent">
                                    <h3>Dokumen Pemutusan Kontrak </h3>
                                </div>
