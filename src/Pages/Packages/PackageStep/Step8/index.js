...
export default function PackageStep8Page() {
    ...
    const handleDownload = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/docs/format_rencana_mutu.pdf`;
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep8Document(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep8Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep8ById(cookies.token, stepDocumentId);
    ...
    const loadDocumentApproved = async () => {
        try {
            let response = await getPackageStep8ById(cookies.token, approveId);
                                ...
                                <Form onSubmit={(e) => {
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Select disabled={newDocument.id !== 0} onChange={(e) => {
                                            ...
                                            <option value={0}>Dokumen Rencana Mutu</option>
                                            <option value={1}>Dokumen Rencana Keselamatan Kerja</option>
