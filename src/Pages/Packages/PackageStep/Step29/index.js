...
import {
    ...
    insertUpdatePackageStep29,getPackageStep29ById,
    updateStep29DocumentStatus,
    getPackageStep29Document,
...
export default function PackageStep29Page() {
    ...
    const handleDownload = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/docs/undangan_pemeriksaan_bersama.docx`;

        // Set the download attribute with the filename
        link.download = 'undangan_pemeriksaan_bersama.docx';
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let res = await insertUpdatePackageStep29(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const downloadData = async () => {
        try {
            let response = await updateStep29DocumentStatus(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep29Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep29ById(cookies.token, stepDocumentId);
    ...
    const loadDocumentApproved = async () => {
        try {
            let response = await getPackageStep29ById(cookies.token, approveId);
    ...
    const ApproveDocument = async (documentId) => {
        try {
            ...
            let response = await updateStep29DocumentStatus(cookies.token, stepPayload);
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                <h5>Unduh dan Unggah Draft Undangan Rapat</h5>
                                            </div>
                                            <div style={{
                                                paddingBottom: 10
                                            }}></div>
                                            ...
                                            <div style={{
                                            ...
                                            }}>
                                                {
                                                    cookies.userRole === 2 && 
                                                    <>
                                                        <div>Unduh Template Undangan Rapat</div>
                                                        <Button style={{
                                                            width: 150,
                                                            height: 40
                                                        }} onClick={() => {
                                                    ...
                                                    <Table  striped bordered hover>
                                                        <thead >
                                                            <tr>
                                                                ...
                                                                <th style={{ width: 120, textAlign: "center" }} hidden={cookies.userRole !== 1}>Setuju</th>
                        ...
                        <Modal show={showDocumentUploadModal}
                            ...
                            <div className="details m-2" >
                                <div className="detailscontent">
                                    <h3>Dokumen Undangan Rapat Pemeriksaan Bersama </h3>
                                </div>
