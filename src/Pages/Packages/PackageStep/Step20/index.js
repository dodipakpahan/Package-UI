...
import {
    ...
    insertUpdatePackageStep20,
    getPackageStep20ById,
    getPackageStep20Document,
...
export default function PackageStep20Page() {
    ...
    const handleDownload = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/docs/berita_acara_rapat_rencana_perubahan_kontrak.docx`;

        // Set the download attribute with the filename
        link.download = 'berita_acara_rapat_rencana_perubahan_kontrak.docx';

        // Programmatically click the link to trigger the download
        link.click();
    };

    const handleDownloadTeknisHarga = () => {
        // Create a link element
        const link = document.createElement('a');

        // Set the href attribute to the path of the file in the public directory
        link.href = `${process.env.PUBLIC_URL}/docs/berita_acara_negosiasi_teknis_dan_harga.docx`;

        // Set the download attribute with the filename
        link.download = 'berita_acara_negosiasi_teknis_dan_harga.docx';

        // Programmatically click the link to trigger the download
        link.click();
    };

    const handleDownloadAdendum = () => {
        // Create a link element
        const link = document.createElement('a');

        // Set the href attribute to the path of the file in the public directory
        link.href = `${process.env.PUBLIC_URL}/docs/draft_perubahan_kontrak.docx`;

        // Set the download attribute with the filename
        link.download = 'draft_perubahan_kontrak.docx';
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep20(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep20ById(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep20Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep20ById(cookies.token, stepDocumentId);
    ...
    const removeDocument = async () => {
        try {
            let response = await deleteDocumentStep(cookies.token, removeId, 20);
            if (response === 0) {
                                            ...
                                            <div style={{
                                            ...
                                            }}>
                                                {
                                                    ...
                                                    <>
                                                        ...
                                                        {/* <div>Unduh Template Dokumen BA Negosiasi Teknis dan Harga</div>
                                                        <Button style={{
                                                            width: 150,
                                                            height: 40
                                                        }} onClick={() => {
                                                            handleDownloadTeknisHarga()
                                                        }}><p style={{ fontSize: 10, alignItems: "center" }}><FileWord size={20} /> Unduh Format Word</p> </Button>


                                                        <div>Unduh Template Dokumen Perubahan Kontrak</div>
                                                        <Button style={{
                                                            width: 150,
                                                            height: 40
                                                        }} onClick={() => {
                                                            handleDownloadAdendum()
                                                        }}><p style={{ fontSize: 10, alignItems: "center" }}><FileWord size={20} /> Unduh Format Word</p> </Button> */}
                                                ...
                                                <div style={{
                                                    ...
                                                    <div hidden={cookies.userRole !== 2} style={{
                                                        ...
                                                        <Button hidden={listDocument.length > 2} variant="primary" style={{
                                                            width: 130
                                                        }} onClick={() => {
                                                            setShowDocumentUploadModal(true);
                                                        }}>
