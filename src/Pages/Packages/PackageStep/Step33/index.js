...
import {
    ...
    insertUpdatePackageStep33,
    getPackageStep33ById,
    getPackageStep33Document,
...
export default function PackageStep33Page() {
    ...
    const handleDownload = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/docs/template_jaminan_pemeliharaan.pdf`;

        // Set the download attribute with the filename
        link.download = 'template_jaminan_pemeliharaan.pdf';
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep33(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep33ById(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep33Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep33ById(cookies.token, stepDocumentId);
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                <h5>Unduh dan Unggah Jaminan Pemeliharaan</h5>
                                            </div>
                                            <div style={{
                                                paddingBottom: 10
                                            }}></div>
                                            ...
                                            <div style={{
                                            ...
                                            }}>
                                                {
                                                    cookies.userRole === 4 &&
                                                    <>
                                                        <div>Unduh Template Jaminan Pemeliharaan</div>
                                                        <Button style={{
                                                            width: 150,
                                                            height: 40
                                                        }} onClick={() => {
                                                            handleDownload()
                                                        }}><p style={{ fontSize: 10, alignItems: "center" }}><FilePdf size={20} /> Unduh Format PDF</p> </Button>
                        ...
                        <Modal show={showDocumentUploadModal}
                            ...
                            <div className="details m-2" >
                                <div className="detailscontent">
                                    <h3>Dokumen Jaminan Pemeliharaan </h3>
                                </div>
