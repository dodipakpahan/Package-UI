...
import {
    ...
    insertUpdatePackageStep19, getPackageStep19ById,
    updateStep19DocumentStatus,
    getPackageStep19Document,
    deleteDocumentStep
...
export default function PackageStep19Page() {
    ...
    const handleDownload = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/docs/undangan_perubahan_kontrak.docx`;

        // Set the download attribute with the filename
        link.download = 'undangan_perubahan_kontrak.docx';
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let res = await insertUpdatePackageStep19(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep19ById(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep19Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep19ById(cookies.token, stepDocumentId);
    ...
    const loadDocumentApproved = async () => {
        try {
            let response = await getPackageStep19ById(cookies.token, approveId);
    ...
    const ApproveDocument = async (documentId) => {
        try {
            ...
            let response = await updateStep19DocumentStatus(cookies.token, stepPayload);
    ...
    const removeDocument = async () => {
        try {
            let response = await deleteDocumentStep(cookies.token, removeId, 19);
            if (response === 0) {
