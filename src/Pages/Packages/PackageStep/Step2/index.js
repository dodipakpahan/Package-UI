...
export default function PackageStep2Page() {
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep2(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const ApproveDocument = async (documentId) => {
        try {
            ...
            let response = await updateStep2DocumentStatus(cookies.token, stepPayload);
