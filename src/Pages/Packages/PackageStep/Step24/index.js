...
export default function PackageStep24Page() {
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep24(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const ApproveDocument = async (documentId) => {
        try {
            ...
            let response = await updateStep24DocumentStatus(cookies.token, stepPayload);
