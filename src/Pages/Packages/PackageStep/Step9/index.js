...
export default function PackageStep9Page() {
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep9(cookies.token, newDocument, packageId, window.location.pathname);
    ...
    const ApproveDocument = async (documentId) => {
        try {
            ...
            let response = await updateStep9DocumentStatus(cookies.token, stepPayload);
