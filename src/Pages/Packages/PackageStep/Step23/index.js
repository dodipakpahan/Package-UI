...
import {
    ...
    insertUpdatePackageStep23,
    getPackageStep23ById,
    getPackageStep23Document,
    updateStep23DocumentStatus,
    deleteDocumentStep
...
export default function PackageStep23Page() {
    ...
    const removeDocument = async () => {
        try {
            let response = await deleteDocumentStep(cookies.token, removeId, 23);
            if (response === 0) {
    ...
    const uploadDocument = async () => {
        return new Promise(async (resolve, reject) => {
            try {
                let res = await insertUpdatePackageStep23(cookies.token, newDocument, packageId, window.location.pathname, detailPackage.account_type);
    ...
    const downloadData = async () => {
        try {
            let response = await getPackageStep23ById(cookies.token, downloadDocumentId);
    ...
    const loadDocumentData = async () => {
        try {
            ...
            let listDocument = await getPackageStep23Document(cookies.token, stepId);
    ...
    const loadDocumentById = async () => {
        try {
            let response = await getPackageStep23ById(cookies.token, stepDocumentId);
    ...
    const loadDocumentApproved = async () => {
        try {
            let response = await getPackageStep23ById(cookies.token, approveId);
    ...
    const ApproveDocument = async (documentId) => {
        try {
            ...
            let response = await updateStep23DocumentStatus(cookies.token, stepPayload, detailPackage.account_type);
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                {
                                                    (cookies.userRole === 2 || cookies.userRole === 4) &&
                                                    <>
                                                ...
                                                <div style={{
                                                    ...
                                                    <div hidden={cookies.userRole !== 4 && cookies.userRole !== 2} style={{
                                                        ...
                                                        <Button hidden={cookies.userRole === 4 ? listDocument.length > 0 : (listDocument.length < 1)} variant="primary" style={{
                                                            width: 130
                                                        }} onClick={() => {
                                                            setShowDocumentUploadModal(true);
                                                        }}>
                                                    ...
                                                    <Table striped bordered hover>
                                                        <thead >
                                                            <tr>
                                                                ...
                                                                <th hidden={cookies.userRole !== 4 && cookies.userRole !== 2} style={{ width: 85, textAlign: "center", verticalAlign: 'middle' }}>Edit</th>
                                                                ...
                                                                <th style={{ width: 85, textAlign: "center", verticalAlign: "middle" }} hidden={cookies.userRole !== 4 && cookies.userRole !== 2}>Hapus</th>
                                                                ...
                                                                listDocument.map((docs, index) => {
                                                                    return (
                                                                        <tr key={index}>
                                                                            ...
                                                                            <td hidden={cookies.userRole !== 4 && cookies.userRole !== 2} style={{ textAlign: "center", verticalAlign:"top" }}>
                                                                                <Button disabled={docs.created_by !== cookies.userId} style={{ width: 50 }} onClick={() => {
                                                                                setNewDocument(docs)
                                                                            ...
                                                                            <td style={{ textAlign: "center", verticalAlign:"top" }} hidden={cookies.userRole !== 1}><Button variant="success" hidden={!docs.document_status_name} style={{ width: 50 }} onClick={() => {
                                ...
                                <Form onSubmit={(e) => {
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Select disabled={newDocument.id !== 0} onChange={(e) => {
                                            ...
                                            <option value={1}>BA Serah Terima Pertama</option>
